 ...
 */
package com.mycompany.game_snake;
import java.awt.*;
...
public class snake {
    ...
    JButton[] bounsfood;
    JTextArea T;
    int x = 100,y = 500, gu=2, directionx=1, directiony=0, speed=100, difference=0, oldx, oldy, score=0;
    int[] lbx = new int[600];
    int[] lby = new int[600];
    Point[] lbp = new Point[600];
    Point bfp = new Point();
    Thread myt;
    boolean food = false, runl=false, runr=true, runu=true, rund=true, bounceflex = true;
    Random r = new Random();
    JMenuBar mymbar;
    JMenu game, help, level;
     ...
     snake(){
        ...
        p1 = new JPanel();
        p2 = new JPanel();
        JTextArea t=new JTextArea ("Score==>"+score);
        t.setEnabled(false);
        t.setBackground (Color.BLACK);
        JButton bounsfood=new JButton();
    ...
    public void creatbar () {
        ...
        creator.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent e){
                JOptionPane.showMessageDialog(p2, "Name"+":Budi");
            }
        });
        help.add(creator);
