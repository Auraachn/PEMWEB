    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <form action="bus_form.php" method="POST">
            
            <div class="form-group">
              <label>ID Bus</label>
              <input type="text" class="form-control" placeholder="no id" name="id_bus" required="required">
            </div>
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" placeholder="status" name="status" required="required">
            </div>
